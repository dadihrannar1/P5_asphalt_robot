...
% Import the data
accuracytest1 = readtable("C:\Users\mikip\Documents\P5_asphalt_robot\preliminary_tests\precision test results\accuracy_test_1.txt", opts);
accuracytest2 = readtable("C:\Users\mikip\Documents\P5_asphalt_robot\preliminary_tests\precision test results\accuracy_test_2.txt", opts);
accuracytest3 = readtable("C:\Users\mikip\Documents\P5_asphalt_robot\preliminary_tests\precision test results\accuracy_test_3.txt", opts);
accuracytest4 = readtable("C:\Users\mikip\Documents\P5_asphalt_robot\preliminary_tests\precision test results\accuracy_test_4.txt", opts);
accuracytest5 = readtable("C:\Users\mikip\Documents\P5_asphalt_robot\preliminary_tests\precision test results\accuracy_test_5.txt", opts);
...
significance1 = 3.5*deviation1+average1;
...
significance2 = 3.5*deviation2+average2;
...
significance3 = 3.5*deviation3+average3;
...
significance4 = 3.5*deviation4+average4;
...
significance5 = 3.5*deviation5+average5;
